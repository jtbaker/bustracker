...
const FeedMessage = (exports.FeedMessage = {});
...
FeedHeader.write = function(obj, pbf) {
  ...
  if (
    obj.incrementality != undefined &&
    obj.incrementality !== { value: 0, options: {} }
  )
...
TripUpdate.StopTimeUpdate.write = function(obj, pbf) {
  ...
  if (obj.departure)
    pbf.writeMessage(3, TripUpdate.StopTimeEvent.write, obj.departure);
  if (
    obj.schedule_relationship != undefined &&
    obj.schedule_relationship !== { value: 0, options: {} }
  )
...
VehiclePosition.write = function(obj, pbf) {
  ...
  if (
    obj.current_status != undefined &&
    obj.current_status !== { value: 2, options: {} }
  )
...
Alert.write = function(obj, pbf) {
  ...
  if (obj.informed_entity)
    for (i = 0; i < obj.informed_entity.length; i++)
      pbf.writeMessage(5, EntitySelector.write, obj.informed_entity[i]);
  if (obj.cause != undefined && obj.cause !== { value: 1, options: {} })
    pbf.writeVarintField(6, obj.cause);
  if (obj.effect != undefined && obj.effect !== { value: 8, options: {} })
    pbf.writeVarintField(7, obj.effect);
